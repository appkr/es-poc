...
public class Constants {
  ...
  public static final String PROJECT_NAME = "espoc";
  public static final String SYSTEM_ACCOUNT = "system";
  public static final String UNKNOWN_USER_ID = "00000000-0000-0000-0000-000000000000";
  public static final String V1_MEDIA_TYPE = "application/vnd.appkr.private.v1+json";
  ...
  public static class LogKey {
    public static final String HTTP_INBOUND_LOGGER = "dev.appkr.espoc.http.api";
    public static final String HTTP_OUTBOUND_LOGGER = "dev.appkr.espoc.http.external";
