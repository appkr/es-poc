package dev.appkr.espoc.api;

import static dev.appkr.espoc.api.error.ErrorConstants.CONSTRAINT_VIOLATION_TYPE;
import static java.util.Arrays.asList;

import dev.appkr.espoc.api.error.BadRequestAlertException;
import dev.appkr.espoc.api.model.ExampleDto;
import dev.appkr.espoc.api.model.ExampleListDto;
import dev.appkr.espoc.api.model.PageDto;
...
public class ExampleApiDelegateImpl implements ExampleApiDelegate {
   ...
   * {
   *   "type": "espoc/problem-with-message",
   *   "title": "Unauthorized",
   *   "status": 401,
   ...
   * {
   *   "errorKey": "espoc/constraint-violation",
   *   "type": "espoc/problem-with-message",
   *   "title": "Unacceptable type given: Unacceptable",
   *   "status": 400,
   *   "message": "error.espoc/constraint-violation",
   *   "params": null
   * }
   * ```
   *
